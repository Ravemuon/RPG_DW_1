...
@section('title', 'Criar Nova Classe')

@section('content')

<div class="container mx-auto p-4">
<div class="max-w-5xl mx-auto bg-white dark:bg-gray-800 shadow-xl rounded-xl p-8">
<h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6 border-b pb-2">Definir Nova Classe</h1>
    ...
    <form action="{{ route('classes.store') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nome" id="nome" required
                           ...
                           value="{{ old('nome') }}" placeholder="Ex: Guerreiro, Ocultista">
                ...
                <div>
                    ...
                    <input type="text" name="sistemaRPG" id="sistemaRPG" required
                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100"
                           value="{{ old('sistemaRPG') }}" placeholder="Ex: D&D 5e, Ordem Paranormal, Chamado de Cthulhu">
            ...
            <div>
                ...
                <textarea name="descricao" id="descricao" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100"
                          placeholder="Descreva o papel da classe no jogo.">{{ old('descricao') }}</textarea>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Insira dados JSON brutos para aspectos, poderes e atributos customizados. Deixe em branco se não for aplicável. <br>Exemplo para "Aspects": <code>["High Concept: Detective", "Trouble: Debtor"]</code></p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <textarea name="aspects" id="aspects" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100">{{ old('aspects') ? json_encode(old('aspects')) : '' }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="stunts" id="stunts" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100">{{ old('stunts') ? json_encode(old('stunts')) : '' }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="poderes" id="poderes" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100">{{ old('poderes') ? json_encode(old('poderes')) : '' }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="atributos_custom" id="atributos_custom" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100">{{ old('atributos_custom') ? json_encode(old('atributos_custom')) : '' }}</textarea>
        ...
        <div class="mt-8 flex justify-end space-x-3 border-t pt-4">
            ...
            <button type="submit"
                    class="px-6 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 transition duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                Salvar Classe
            </button>
        </div>
    </form>
